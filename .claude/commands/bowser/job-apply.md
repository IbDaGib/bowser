---
model: opus
description: Apply to multiple jobs sequentially via Simplify links — auto-fills with Simplify extension, fills gaps from resume/profile, handles verification, submits
